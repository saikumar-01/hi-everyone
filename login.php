...
<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 login1 p-l-55 p-r-55 p-t-65 p-b-54">
                        ...
                        <div class="card-body">
                            ...
                            <?php include('errors.php'); ?>
                                <div class="form-group row mt-3">
                                    <div class="col-md-12">
                                    <label style="display: none;">Lusername</label>
                                        <input name= "username" class="form-control" type="text" required="" placeholder="User name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                    <label style="display: none;">Lpassword</label>
                                ...
                                <div class="form-group row text-center mt-4">
                                    <div class="col-md-12">
                                        <button name="log_user" type="submit" class="btn btn-primary btn-block text-uppercase">Log In</button>
                                    </div>
                                </div>
                            </form>
                        </div>
